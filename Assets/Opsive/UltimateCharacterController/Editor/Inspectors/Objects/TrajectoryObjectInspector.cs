    ...
    public class TrajectoryObjectInspector : UIElementsInspector
    {
        ...
        protected override void ShowHeaderElements(VisualElement container)
        {
            ...
            PropertiesFoldout(container, "Physics", m_ExcludeFields, new[]
            {
                ...
                "m_SettlePositionThreshold",
                "m_SettleRotationThreshold",
        ...
        /// <param name="dirty">Has the parameter values been changed?</param>
        private void OnCollisionModeChange(TrajectoryObject.CollisionMode newValue, bool dirty)
        {
