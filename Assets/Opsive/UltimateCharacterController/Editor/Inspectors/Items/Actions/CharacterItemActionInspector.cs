...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    /// </summary>
    public class CharacterItemActionModuleGroupField : GenericReorderableList<ActionModule>
    {
        ...
        public override void Setup(string title, Object target, Func<IList<ActionModule>> get, Action<IList<ActionModule>> set, SerializedProperty serializedProperty)
        {
        ...
        /// <returns>True if the module was drawn.</returns>
        protected override bool DrawModule(int index)
        {
            ...
            FieldInspectorView.AddFields(m_Target,module, Shared.Utility.MemberVisibility.Public, m_SelectedModuleContainer,
                (object obj) =>
                {
                    ...
                    InvokeValueChanged();
                }, m_SerializedProperty.GetArrayElementAtIndex(index), null, true, null);
        ...
        protected override void AddModule(object obj)
        {
        ...
        {
            //Do not call base.Refresh intentionally.
                ...
                for (int i = 0; i < m_InLineFields.Length; i++) {
                    ...
                    FieldInspectorView.AddField(m_Target, m_Module, fieldInfo, null, -1, fieldInfo.FieldType,
                        ...
                        m_OtherFieldsContainer, (newValue) =>
                        {
                            ...
                            if (fieldInfo.Name == "m_Enabled") {
                                m_Module.Enabled = (bool)newValue;
                            } else {
