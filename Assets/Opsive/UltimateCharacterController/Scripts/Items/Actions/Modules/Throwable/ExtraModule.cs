...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Throwable
{
    ...
    /// </summary>
    [Serializable]
    public class ThrowableVisualizeTrajectory : ThrowableExtraModule, IModuleOnAim, IModuleStartItemUse
    {
        ...
        public bool ShowTrajectoryOnAim { get { return m_ShowTrajectoryOnAim; } set { m_ShowTrajectoryOnAim = value; if (!value && m_TrajectoryObject != null) {
        ...
        protected override void UpdateRegisteredEventsInternal(bool register)
        {
            ...
            if (register) {
                m_CharacterItemAction.OnLateUpdateEvent += OnLateUpdate;
            } else {
                m_CharacterItemAction.OnLateUpdateEvent -= OnLateUpdate;
            }
        }
        ...
        public void OnLateUpdate()
        {
            ...
            var canShow = !ThrowableAction.IsThrowing && !ThrowableAction.IsReequipping && m_TrajectoryObject != null;
            if (m_CharacterItemAction.IsDebugging) {
                m_CharacterItemAction.DebugLogger.SetInfo("Throwable/VisualizeTrajectory/CanShow",
                    canShow+ $" Why? (isThrowing:{ThrowableAction.IsThrowing}, isReequiping:{ThrowableAction.IsReequipping}, TrajectoryObject:{m_TrajectoryObject})"); 
            }
            ...
            m_TrajectoryObject.SimulateTrajectory(Character, trajectoryTransform.TransformPoint(throwPreviewData.TrajectoryOffset), 
                                                    Quaternion.identity, velocity, Vector3.zero);
        }
