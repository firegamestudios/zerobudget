...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public class TrajectoryObject : MonoBehaviour, IForceObject, IDamageSource, ISmoothedObject
    {
        ...
        protected virtual bool Interpolate { get { return false; } }
        ...
        /// <summary>
        /// Called during the FixedUpdate loop.
        /// </summary>
        private void FixedUpdate()
        {
            // If the object isn't interpolating then the object needs to move itself.
            if (!Interpolate) {
                Move();
            }
        }
