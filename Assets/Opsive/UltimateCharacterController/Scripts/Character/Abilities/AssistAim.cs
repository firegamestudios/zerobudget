...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class AssistAim : Ability
    {
        ...
        public override void UpdateRotation()
        {
            ...
            var direction = Vector3.ProjectOnPlane(m_Target.TransformPoint(m_TargetOffset + (m_TargetPivotOffset != null ? m_TargetPivotOffset.Offset : Vector3.zero)) - m_CharacterLocomotion.TransformPoint(m_CenterOffset), m_CharacterLocomotion.Up);
            var targetRotation = Quaternion.LookRotation(direction, m_CharacterLocomotion.Up);
            targetRotation = Quaternion.Slerp(m_CharacterLocomotion.Rotation, targetRotation, m_CharacterLocomotion.MotorRotationSpeed);
